                          ...
                          <div className="flex items-center gap-2 justify-end">
                            {isDatasetOutdated(dataset) && (
                              <button
                                ...
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium text-primary-foreground bg-primary hover:bg-primary/90 transition-colors"
